...
We use this data to run Veloseete features: sync your garage across devices (via Firebase), show maps and stats, schedule helpful reminders, and power widgets / CarPlay / Live Activities when enabled.
...
- **Firebase (Google)** — authentication and cloud database for your account.
- **Apple** — Sign in with Apple, Maps/location services, notifications, widgets, and (if enabled) CarPlay.
- **Google** — Google Sign-In when you choose that method.
